    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      >
        ...
        <input
          ...
          className="flex-grow bg-transparent border-none outline-none text-black px-3 md:px-4 py-3 md:py-4 placeholder:text-[#86868b] text-base md:text-lg font-bold"
          disabled={loading}
        />
        ...
        <button
          type="button"
          onClick={toggleVoice}
          className={`p-3 md:p-4 rounded-full transition-all flex items-center justify-center mr-1 ${isListening ? 'bg-black text-white shadow-lg' : 'text-[#86868b] hover:text-black hover:bg-[#f5f5f7]'}`}
          title="Voice Search"
        >
        ...
        <button
          ...
          className="btn-apple px-6 md:px-8 py-3.5 md:py-4 disabled:opacity-20 text-[11px] md:text-[13px] uppercase tracking-widest font-extrabold"
        >
          {loading ? "..." : "Go"}
        </button>
      </form>
