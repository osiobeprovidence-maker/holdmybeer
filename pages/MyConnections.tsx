    ...
    <div className="py-12 animate-in fade-in duration-700">
      <div className="mb-24 flex flex-col md:flex-row justify-between items-end gap-10">
        <div>
          ...
          <h1 className="text-6xl md:text-8xl font-extrabold mb-6 tracking-tighter text-black uppercase leading-none">History</h1>
      ...
      <div className="grid grid-cols-1 gap-10">
        {connectedVendors.map(vendor => {
          ...
          return (
            <div key={vendor.id} className="apple-card p-8 md:p-12 apple-shadow flex flex-col md:flex-row gap-12 items-center">
              <div className="w-32 h-32 md:w-48 md:h-48 flex-shrink-0">
                 <img src={vendor.avatar} className="w-full h-full rounded-[40px] object-cover apple-shadow" />
              </div>
