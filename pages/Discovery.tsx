  ...
  return (
    <div className="pb-12 animate-in fade-in duration-700">
      <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-10">
        <div>
          <h1 className="text-5xl md:text-8xl font-extrabold mb-4 tracking-tighter text-black uppercase">Discovered</h1>
        ...
        <button 
          ...
          className={`w-full md:w-auto px-10 py-4 text-[12px] font-black uppercase tracking-[0.2em] transition-all border-2 rounded-full ${
            isUrgent 
