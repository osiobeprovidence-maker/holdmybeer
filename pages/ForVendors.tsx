        ...
        <div className="pb-24 max-w-6xl mx-auto px-6 animate-in fade-in duration-700">
            ...
            <section className="space-y-40 mb-40">
                <div className="flex flex-col md:flex-row gap-12 md:gap-24 items-center">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <h2 className="text-3xl md:text-7xl font-black mb-8 tracking-tighter text-black leading-none uppercase italic">Create Your <br />Listing.</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-40">
                <div className="bg-zinc-900 p-12 md:p-20 rounded-[64px] text-white">
                    <h3 className="text-3xl md:text-4xl font-black mb-12 tracking-tighter uppercase italic">Quality Codes</h3>
                ...
                <div className="bg-[#f5f5f7] p-12 md:p-20 rounded-[64px] border border-black/5">
                    <h3 className="text-3xl md:text-4xl font-black mb-12 tracking-tighter uppercase italic leading-none">Who Should <br />Join?</h3>
            ...
            <section className="text-center py-24 bg-black rounded-[64px] text-white relative overflow-hidden group">
                ...
                <h2 className="text-4xl md:text-8xl font-black mb-12 tracking-tighter uppercase italic leading-none">Ready to <br />Launch?</h2>
