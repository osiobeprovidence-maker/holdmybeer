  ...
  return (
    <div className="py-12 md:py-24 max-w-5xl mx-auto px-4 md:px-6 animate-in fade-in duration-700">
      <div className="text-center mb-16 md:mb-24">
        <p className="text-[12px] md:text-[14px] font-bold text-black/40 uppercase tracking-[0.4em] mb-4 md:mb-6">Access Fees</p>
        <h1 className="text-5xl md:text-9xl font-extrabold mb-6 md:mb-8 tracking-tighter text-black uppercase leading-[0.9]">Pricing</h1>
        <p className="text-lg md:text-2xl text-[#86868b] max-w-2xl mx-auto font-medium leading-relaxed uppercase tracking-tight">
          Direct connection fees. No middleman. No sub-balances.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="apple-card p-8 md:p-16 apple-shadow flex flex-col mx-4 md:mx-0">
          <h3 className="text-2xl md:text-3xl font-extrabold mb-6 md:mb-8 text-black tracking-tight uppercase">Standard Handshake</h3>
          <p className="text-[#86868b] mb-10 md:mb-12 text-base md:text-lg font-bold uppercase tracking-widest leading-relaxed opacity-60">Instant access to a verified expert's contact signals.</p>
        ...
        <div className="apple-card p-8 md:p-16 apple-shadow bg-black text-white flex flex-col mx-4 md:mx-0 md:scale-[1.03]">
          ...
          <h3 className="text-2xl md:text-3xl font-extrabold mb-6 md:mb-8 tracking-tight uppercase">Priority Hub</h3>
          <p className="text-white/60 mb-10 md:mb-12 text-base md:text-lg font-bold uppercase tracking-widest leading-relaxed">Secure your positioning in the expert retrieval list.</p>
          <div className="mt-auto">
