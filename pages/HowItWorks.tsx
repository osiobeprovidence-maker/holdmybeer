  ...
  return (
    <div className="py-12 md:py-24 max-w-4xl mx-auto px-4 md:px-6 animate-in fade-in duration-700">
      <div className="text-center mb-16 md:mb-40">
        <h1 className="text-4xl md:text-9xl font-extrabold mb-6 md:mb-10 tracking-tighter text-black leading-[0.9] px-2">How it works.</h1>
        <p className="text-base md:text-2xl text-[#86868b] leading-relaxed max-w-2xl mx-auto font-medium px-4">
          Three steps to the perfect event connection. <br className="hidden md:block" />Decisive, fast, and neutral.
        </p>
      </div>

      <div className="space-y-32 md:space-y-64">
        <div className="flex flex-col md:flex-row gap-8 md:gap-24 items-center px-4 md:px-0 text-center md:text-left">
          <div className="w-full md:w-1/2">
            <div className="bg-[#f5f5f7] aspect-square rounded-[32px] md:rounded-[60px] flex items-center justify-center text-[80px] md:text-[160px] apple-shadow">🔎</div>
          </div>
          <div className="w-full md:w-1/2">
            <p className="text-black font-extrabold uppercase tracking-[0.4em] text-[10px] md:text-[13px] mb-3 md:mb-6">Step 01</p>
            <h2 className="text-2xl md:text-5xl font-extrabold mb-4 md:mb-8 tracking-tighter text-black leading-none">Find your fit.</h2>
            <p className="text-sm md:text-xl text-[#86868b] font-medium leading-relaxed">
      ...
      <div className="mt-24 md:mt-64 bg-black rounded-[32px] md:rounded-[80px] p-8 md:p-24 text-center text-white shadow-2xl mx-1 md:mx-0">
        <h2 className="text-2xl md:text-5xl font-extrabold mb-6 md:mb-8 tracking-tighter">Ready for relief?</h2>
        <p className="text-white/60 mb-8 md:mb-16 max-w-sm md:max-w-md mx-auto font-medium text-base md:text-xl leading-relaxed">Find your first connection today and replace event chaos with structure.</p>
        <button onClick={() => window.location.hash = 'home'} className="w-full md:w-auto bg-white text-black font-extrabold px-10 md:px-20 py-4 md:py-8 rounded-full text-base md:text-2xl hover:scale-105 transition-all shadow-xl uppercase tracking-widest border-none">Start Discovery</button>
      </div>
    </div>
  );
};
